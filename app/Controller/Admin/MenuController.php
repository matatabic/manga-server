 ...
 * Time：下午1:58
 *
 * @Controller(prefix="admin_api/v1/menu")
 *
 * @Middlewares({
...
class MenuController extends BaseController
{
    ...
    {
        $list = $this->menuService->getUserMenu();
    ...
    public function store()
    {
        ...
        $id = $this->menuService->saveUserMenu($reqParam);
    ...
    {
        $reqParam = $this->request->all();
        $info = $this->menuService->getInfo($reqParam['id']);
        $pid = isset($info['system_permission_id']) ?$info['system_permission_id']:0;
        $menuPermissions = $this->permissionsService->getMenuPermissionList($pid);
    ...
    public function orderMenu()
    {
        ...
        $this->menuService->orderMenu($reqParam['ids']);
    ...
    {
        $reqParam = $this->request->all();
        $this->menuService->deleteMenuInfo($reqParam['id']);
