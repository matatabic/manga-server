...
class Log extends BaseModel
{
    ...
    {
        $query = $this->query()->select($this->table . '.' . $groupField, Db::raw('count(*) AS num'), Db::raw('count(distinct manga_logs.uuid) AS uv'), Db::raw('count(distinct manga_logs.real_ip) AS ip'));
    ...
    {
        $query = $this->query()->select($this->table . '.city_id', Db::raw('count(*) AS value'), Db::raw('count(distinct manga_logs.uuid) AS uv'), Db::raw('count(distinct manga_logs.real_ip) AS ip'));
